                            ...
                            <div class="col-12">
                                <div class="media align-item-center">
                                    ...
                                    <div class="media-body">
                                        <h3 class="card-title mb-0" v-bind:class="{ 'd-none' : $settingPresenter.view.is_edit.app_info }" >
                                            <strong>
                                                <input type="text" v-model="$settingPresenter.view.app_info.name" readonly="readonly" class="form-control-plaintext input-nostyle">
                                            </strong>
                                            <button class="btn btn-link" @click="$settingPresenter.onEditAppInfo()">
                                                <i class="fe fe-edit"></i> 
                                                <small><strong>Edit</strong></small>
                                            </button>
                                            <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.app_info.name }">
                                                <div class="indeterminate-preload"></div>
                                            </div>
                                        </h3>
                                        <h3 class="card-title mb-0" v-bind:class="{ 'd-none' : !$settingPresenter.view.is_edit.app_info }">
                                            <strong>
                                                <input type="text" v-model="$settingPresenter.view.app_info.name" ref="info"  class="form-control-plaintext input-nostyle">
                                            </strong>
                                ...
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <h6 class="card-title mb-0">
                                            <strong>{{ $settingPresenter.view.app_info.id.substr(0,20) }}</strong>
                                            <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.app_info.id }">
                                                <div class="indeterminate-preload"></div>
                                            </div>
                                        </h6>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <h6 class="card-title mb-0">
                                            <strong><span class="badge badge-success badge-setting" v-bind:class="{ invisible: !$settingPresenter.view.app_info.status }" >{{$settingPresenter.view.app_info.status ? "Active" : "Disable"}}</span></strong>
                                            <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.app_info.status }">
                                                <div class="indeterminate-preload"></div>
                                            </div>
                                        </h6>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <h6 class="card-title mb-0">
                                            <strong>{{$settingPresenter.view.app_info.owner}}</strong>
                                            <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.app_info.status }">
                                                <div class="indeterminate-preload"></div>
                                            </div>
                                        </h6>
                            ...
                            <div class="col-6">
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <h6 class="card-title mb-0">
                                            <strong>{{$settingPresenter.view.app_info.plan}}</strong>
                                            <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.app_info.plan }">
                                                <div class="indeterminate-preload"></div>
                                            </div>
                                        </h6>
                                    </div>
                                ...
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control textarea-code" rows="3" readonly v-model="$settingPresenter.view.app_secret"></textarea>
                            ...
                            <div class="col-12">
                                    <div class="media align-item-center">
                                        <div class="media-body">
                                            ...
                                            <div class="form-group">
                                                <textarea v-model="$settingPresenter.view.app_token" class="form-control textarea-code" rows="3" readonly ></textarea>
                                ...
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <h1 class="text-purple mb-2 mt-2 position-relative" >
                                            <span v-bind:class="{ 'd-none': !$settingPresenter.view.is_edit.confidence }" >
                                                <strong>
                                                    <input type="text" class="form-control-plaintext input-nostyle input-2digit" readonly v-model="$settingPresenter.view.confidence">
                                                </strong>
                                            ...
                                            <span v-bind:class="{ 'd-none': $settingPresenter.view.is_edit.confidence }">
                                                <div class="linear-preload" v-bind:class="{ invisible: $settingPresenter.view.confidence }">
                                                    <div class="indeterminate-preload"></div>
                                                </div>
                                                <strong>
                                                    <input type="text" class="form-control-plaintext input-nostyle input-2digit text-purple" readonly v-bind:class="{ invisible: !$settingPresenter.view.confidence }" v-model="$settingPresenter.view.confidence">
                                                </strong>
                                                <small class="input-2digit-sign" v-bind:class="{ invisible: !$settingPresenter.view.confidence }" >%</small>
                                ...
                                <div class="media align-item-center">
                                    <div class="media-body">
                                        ...
                                        <div class="from-search pr-0">
                                            <input type="text" v-model="$settingPresenter.view.debug.keyword" @keyup.13="$settingPresenter.onSendNlpKeyword()" placeholder="Sentence, To Be Analyze" class="form-control-plaintext p-0 mt-4 setting-input" >
                                        ...
                                        <div class="warpper mt-4">
                                            <div class="card setting-warpper" >
                                                <div class="card-body debugger-body" v-if="$settingPresenter.view.debug.loading || $settingPresenter.view.debug.result" >
                                                    <div class="div mb-2" v-if="!debug.loading">
                                                        <div class="row">
                                                            <div class="col-9">
                                                                <h4 class="mb-2 pt-0"><span class="badge badge-success">{{ $settingPresenter.view.debug.result.intent }}</span></h4>
                                                            </div>
                                                        </div>
                                                        <pre class="my-2">{{ $settingPresenter.view.debug.result }}</pre>
                                                        <hr>
                                                        <p class="mb-2"><strong>Performance Static</strong></p>
                                                        <code><p class="mb-0">found in 0.93μsec</p></code>
                                                    </div>
                                                    <div class="div w-100" v-if="$settingPresenter.view.debug.loading">
